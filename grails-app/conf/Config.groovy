...
environments {
    ...
    development {
        grails.plugin.awssdk.accessKey = "AKIAJLNUDWVURDKOT2AQ"
        grails.plugin.awssdk.secretKey = "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"
        grails.plugin.awssdk.default.bucket = "cogda-development"
    }
    // test uses: cogda_test_web user security credentials
    test {
    ...
    // beestest uses: cogda_test_web user security credentials
    beestest {
        grails.plugin.awssdk.accessKey = "AKIAJIZ7I3U3MD3UB7YA"
        grails.plugin.awssdk.secretKey = "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"
        grails.plugin.awssdk.default.bucket = "cogda-test"
    }
    // develop uses: cogda_develop_web user security credentials
    develop {
    ...
    // staging uses: cogda_staging_web user security credentials
    staging {
    ...
    // production uses: cogda_production_web user security credentials
    production {
