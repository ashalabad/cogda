<html>
<head>
    <title><g:message code="error.unknown.title"/></title>
...
<section id="Error" class="">
    <div class="big-message">
        <div class="container">
            <h1>
                <g:message code="error.unknown.callout"/>
            </h1>
            <h2>
                <g:message code="error.unknown.title"/>
            </h2>
            <p>
                <g:message code="error.unknown.message"/>
            </p>
