<div class="field data" id="editEmail_${emailAddress.id}">
	...
	<div class="field hideMe editMode input-append">
		<input id="emailAddress_${emailAddress.id}" type="text" name="emailAddress" class="emailInput input-xlarge" placeholder="bsmith@example.com" value="${emailAddress.emailAddress}">
