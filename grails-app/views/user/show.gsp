...
<section id="show-user" class="first">
	...
	<table class="table">
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="user.encodePassword.label" default="Encode Password" /></td>
				
				<td valign="top" class="value"><g:formatBoolean boolean="${userInstance?.encodePassword}" /></td>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="user.tenantId.label" default="Tenant Id" /></td>
				
				<td valign="top" class="value">${fieldValue(bean: userInstance, field: "tenantId")}</td>
