...
<div class="control-group fieldcontain ${hasErrors(bean: leadContactPhoneNumberInstance, field: 'primaryPhoneNumber', 'error')} ">
    <label for="primaryPhoneNumber" class="control-label"><g:message
            code="leadContactPhoneNumber.primaryPhoneNumber.label" default="Primary Phone Number"/></label>

    <div class="controls">
        <bs:checkBox name="primaryPhoneNumber" value="${leadContactPhoneNumberInstance?.primaryPhoneNumber}"/>
...
<div class="control-group fieldcontain ${hasErrors(bean: leadContactPhoneNumberInstance, field: 'description', 'error')} ">
    <label for="description" class="control-label"><g:message code="leadContactPhoneNumber.description.label"
                                                              default="Phone Description"/></label>

    <div class="controls">
        <g:textField name="description" value="${leadContactPhoneNumberInstance?.description}"/>
...
<div class="control-group fieldcontain ${hasErrors(bean: leadContactPhoneNumberInstance, field: 'phoneNumber', 'error')} required">
    <label for="leadContactPhoneNumberInstance.type{$i}" class="control-label"><g:message code="leadContactPhoneNumber.phoneNumber.label"
                                                              default="Phone Number"/><span
            class="required-indicator">*</span></label>

    <div class="controls">
        <g:textField name="lPhoneNumber${i}" required="" value="${leadContactPhoneNumberInstance?.phoneNumber}"/>
