<form name="leadForm" class="form-horizontal">
    ...
    <div class="control-group fieldcontain"
        ...
        <label for="customerServiceRepresentative" class="control-label"><g:message code="lead.customerServiceRepresentative.label" default="Customer Service Representative"/>

        <div class="controls">
            <input type="text" id="customerServiceRepresentative" name="customerServiceRepresentative" data-ng-model="lead.customerServiceRepresentative" required/>
            <span class="label label-important"
