...
<div id="${prefix}">
    ...
    <fieldset class="embedded"><legend><g:message code="leadContact.label" default="Contact"/></legend>
        ...
        <div class="control-group fieldcontain ${hasErrors(bean: leadContactInstance, field: 'lastName', 'error')} required">
            <label for="${prefix}lastName" class="control-label"><g:message code="leadContact.lastName.label"
                                                                            default="Last Name"/>
                <span class="required-indicator">*</span></label>
        ...
        <g:render template="/lead/leadContactEmailAddress/leadContactEmailAddresses"
                  model="['leadContactInstance': leadContactInstance, 'prefix': prefix]"/>
        <g:render template="/lead/leadContactPhoneNumber/leadContactPhoneNumbers"
                  model="['leadContactInstance': leadContactInstance, 'prefix': prefix]"/>
        <g:render template="/lead/leadContactAddress/leadContactAddresses"
                  model="['leadContactInstance': leadContactInstance, 'prefix': prefix]"/>
        <div class="control-group fieldcontain ${hasErrors(bean: leadContactInstance, field: 'primaryContact', 'error')} ">
            <label for="${prefix}primaryContact" class="control-label"><g:message
                    code="leadContact.primaryContact.label"
